...
BASE_PATH = "/home/harshit/datasets/imagenet/ILSVRC2015"
...
# take a number of images from the training data and use it as testing data
NUM_CLASSES = 1000
NUM_TEST_IMAGES = 50 * NUM_CLASSES

# define the path to the output training, validation, and testing
# lists
MX_OUTPUT = "/home/harshit/datasets/imagenet"
