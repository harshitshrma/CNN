...
from pis.utils.imagenethelper import ImageNetHelper
import numpy as np
import progressbar
import json
import cv2

# initialize the ImageNet helper and use it construct the set of
...
# constuct a list pairing the training, validation, and testing
...
# constuct a dictionary of averages, then serialize the means to a
# JSON file
